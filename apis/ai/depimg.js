// apis/DeepImg/deepimg.js
// ESM version of the original deepimg module
...
export const meta = {
  ...
  params: [
    ...
    },
    {
      name: 'style',
      desc:
        "Image style: 'default' | 'ghibli' | 'cyberpunk' | 'anime' | 'portrait' | 'chibi' | 'pixel art' | 'oil painting' | '3d' (default: 'default')",
      example: 'anime',
      required: false,
      options: [
        'default',
