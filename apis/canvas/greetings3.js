...
export const meta = {
  ...
  params: [
    ...
    { name: 'bg', desc: 'URL to the background image (optional, defaults to a predefined background based on type)', example: 'https://raw.githubusercontent.com/lanceajiro/Storage/refs/heads/main/backiee-265579-landscape.jpg', required: false }
  ]
};
