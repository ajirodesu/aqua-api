...
export const meta = {
  ...
  category: 'canvas',
  params: [
    { name: 'type', desc: 'Type of greeting', options: ['welcome', 'goodbye'], example: 'welcome', required: true },
    ...
    { name: 'groupname', desc: 'The group name to display (required for welcome type)', example: 'Ajiro HQ', required: false },
    { name: 'member', desc: 'The member count to display', example: '57', required: true }
  ]
};
